...
global.recordDetailedApiUsage_ = (modelName, input, output, reasoning, cost) => {
  try {
    ...
    try {
      ...
      console.error(`[Bridge Error] Failed to write api_usage.log: ${fsErr.message}`);
    }
        ...
        if (name === "collect") {
          ...
          db.transaction((rows) => { 
            for (const r of rows) { 
              ...
              stmt.run(r[2], dateVal, r[1], r[2], r[3], r[4]||"", r[5]||"", r[6]||"", r[7]||"", r[8]||"", r[9]||"", r[10]||"", r[11]||"", r[12]||"", r[13]||"", r[14]||"", r[15]||"", r[16]||""); 
            } 
          })(values);
        }
      }
