...
[![Version](https://img.shields.io/badge/version-1.0.0--GAS-blue.svg)]()
...
| :--- | :--- | :--- |
| **v1.0.0** | 2026-03-08 | **Public Launch (GAS Edition)**<br>本家（GAS版）としての最初の公式公開。256次元圧縮、Method Embedding、マルチLLMルーティング等の主要機能を統合。 |
